...
ENTITY 	fsmc IS
	...
	DB : BUFFER std_logic_vector(15 DOWNTO 0)
	);
END fsmc;
...
\u3|u1|altsyncram_component|auto_generated|ram_block1a0_PORTAADDR_bus\ <= (\AB[23]~input_o\ & \AB[22]~input_o\ & \AB[21]~input_o\ & \AB[20]~input_o\ & \AB[19]~input_o\ & \AB[18]~input_o\ & \AB[17]~input_o\ & \AB[16]~input_o\);
...
-- Equation(s):
-- \u3|clk~combout\ = LCELL((\u3|wr_clk1~q\) # ((!\RDn~input_o\ & !\CSn~input_o\)))
